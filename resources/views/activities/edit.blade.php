    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('activities.update', $activity) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="date" name="date" value="{{ $activity->date->isoFormat('YYYY-MM-DD') }}" required>
            </div>

            <div class="mb-3">
                <label for="opening_hours" class="form-label">Horaires</label>
                <input type="text" class="form-control" id="opening_hours" name="opening_hours" value="{{ $activity->opening_hours }}">
            </div>
